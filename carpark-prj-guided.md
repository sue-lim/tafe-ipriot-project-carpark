...
Probably a good idea to commit to GitHub now:
   ...
   git push --tags
   ```
![img_evidence_7.png](img_evidence_7.png)
### Taking stock
...
> Since there is a register method in car_park.py, this test should be within the test_car_park unit test. If the test were anywhere else, such as sensor.py, it would necessitate a test in display.py, resulting in unnecessary duplication. Having the single test within CarPark is much more manageable. 
